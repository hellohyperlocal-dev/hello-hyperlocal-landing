# Hello Hyperlocal — Brand Color System & Production Tokens (Archived)

> [!NOTE]
> This is a legacy color specification. For the active canonical design tokens and Geist Typography System, see [`../design.md`](../design.md).
