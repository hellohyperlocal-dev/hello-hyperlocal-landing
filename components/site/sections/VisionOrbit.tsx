  ...
  return (
    <section id="vision" className="relative overflow-clip bg-hh-forest py-[100px] split:py-[130px]">
      <div className="site-container flex flex-col gap-[70px]">
        ...
        <ScrollRevealText
          className="flex max-w-[1100px] flex-col gap-6 font-heading text-[32px] font-semibold leading-[1.1] tracking-[-1.5px] text-white split:text-[52px] split:tracking-[-2.4px]"
          lines={[
            {
