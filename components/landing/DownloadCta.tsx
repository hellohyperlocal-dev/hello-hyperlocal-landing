...
function CtaPhoneMockup() {
  return (
    <div aria-label="App interface preview: Verified neighbourhood feed" className="relative w-[340px] sm:w-[400px] lg:w-[440px] aspect-[1242/2072] select-none -mb-36 sm:-mb-48 lg:-mb-56">
      ...
      <div className="rounded-[32px] sm:rounded-[36px] bg-[#1C472A] text-white pt-10 sm:pt-14 px-8 sm:px-12 lg:px-14 pb-0 overflow-hidden relative border-none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-end relative z-10">
          ...
          <div className="lg:col-span-7 flex flex-col text-left justify-center pb-10 sm:pb-14">
            <div className="mb-4">
              <EyebrowPill icon={Smartphone} variant="accent">
                Get the App
              </EyebrowPill>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 mt-8">
              ...
              <Link
                href="#"
                aria-label="Download Hello Hyperlocal on Apple App Store"
                className="group flex items-center justify-center gap-3 rounded-full border border-white/20 bg-white/10 hover:bg-white/20 text-white transition-all hover:scale-105 duration-200 px-6 py-3.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7ED957] focus-visible:ring-offset-2 focus-visible:ring-offset-[#1C472A]"
              >
                <svg viewBox="0 0 384 512" aria-hidden="true" className="h-6 w-6 fill-current">
              ...
              <Link
                href="#"
                aria-label="Get Hello Hyperlocal on Google Play Store"
                className="group flex items-center justify-center gap-3 rounded-full border border-white/20 bg-white/10 hover:bg-white/20 text-white transition-all hover:scale-105 duration-200 px-6 py-3.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7ED957] focus-visible:ring-offset-2 focus-visible:ring-offset-[#1C472A]"
              >
                <svg viewBox="0 0 512 512" aria-hidden="true" className="h-6 w-6 fill-current">
