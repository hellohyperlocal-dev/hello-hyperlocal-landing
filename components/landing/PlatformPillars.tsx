  ...
  return (
    ...
    >
      ...
      <div className="text-center max-w-3xl mx-auto mb-16">
        <div className="inline-block rounded-full border border-brand-line-soft bg-brand-panel dark:bg-[#151F17] dark:border-brand-spruce-line px-4 py-1 text-label-12 font-bold tracking-[0.14em] text-brand-hunter dark:text-brand-grass uppercase mb-4">
          Our Commitment
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
        {pillars.map((pillar, index) => {
          ...
          return (
            ...
            >
              {/* Icon Container: Circle with a slightly darker tone of green fill (#c5edab) */}
              <div className="h-14 w-14 rounded-full bg-[#c5edab] dark:bg-[#1C472A] text-[#054d28] dark:text-[#7ED957] flex items-center justify-center mb-6 transition-transform duration-300">
