...
function StickyCardPhone({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative w-[330px] sm:w-[380px] lg:w-[420px] aspect-[1242/2072] select-none -mb-40 sm:-mb-52 lg:-mb-60">
...
const CARDS: FeatureCardSpec[] = [
  {
    ...
    kickerStyle: "bg-[#F5F5F5] dark:bg-white/10 text-[#0e0f0c] dark:text-[#7ED957] border border-[#0e0f0c]/5 dark:border-white/5",
  ...
  },
  {
    ...
    titleColor: "text-[#0e0f0c] dark:text-white",
    mutedColor: "text-[#454745] dark:text-[#99A893]",
    kickerStyle: "bg-white dark:bg-white/10 text-[#054d28] dark:text-[#7ED957] border border-[#0e0f0c]/5 dark:border-white/5",
  ...
  },
  {
    ...
    textColor: "text-[#054d28] dark:text-[#FCFAF7]",
    titleColor: "text-[#054d28] dark:text-white",
    mutedColor: "text-[#054d28]/80 dark:text-[#99A893]",
    kickerStyle: "bg-white dark:bg-white/10 text-[#054d28] dark:text-[#7ED957] border border-[#054d28]/10 dark:border-white/5",
    checkIconBg: "bg-white dark:bg-[#7ED957]/20",
    checkIconColor: "text-[#054d28] dark:text-[#7ED957]",
  ...
  },
  {
    ...
    kickerStyle: "bg-white/10 text-[#7ED957] border border-white/10",
    ...
    >
      <div className="mx-auto max-w-[1240px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mx-auto mb-12 sm:mb-16 max-w-3xl">
          <div className="inline-block rounded-full bg-[#e2f6d5] dark:bg-[#1C472A] px-3.5 py-1 text-label-12 font-bold tracking-[0.14em] text-[#054d28] dark:text-[#7ED957] uppercase mb-4 border border-[#0e0f0c]/5 dark:border-white/5">
            App Experience
          </div>
              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                  ...
                  <div className={`flex flex-col items-start text-left pb-8 sm:pb-10 lg:pb-12 ${isReversed ? "lg:order-2" : "lg:order-1"}`}>
                    <span className={`inline-block rounded-full px-3 py-1 text-label-12-mono font-bold uppercase tracking-wider mb-4 ${card.kickerStyle}`}>
                      {card.kicker}
                    </span>
