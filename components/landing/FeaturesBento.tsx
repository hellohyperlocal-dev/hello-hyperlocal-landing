...
function BentoHomeFeedPhone() {
  return (
    <div className="relative w-full max-w-[440px] sm:max-w-[500px] lg:max-w-[540px] aspect-[1242/2072] select-none -mb-20 sm:-mb-28 lg:-mb-32">
      {/* Screen Viewport - Static & Masked strictly inside phone-2.png hardware cutout */}
      <div className="absolute top-[2.8%] left-[14.65%] w-[68.6%] h-[89.5%] overflow-hidden rounded-[26px] sm:rounded-[36px] bg-[#FCFAF7] z-0 flex flex-col shadow-inner pointer-events-none">
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-3 flex flex-col gap-6 self-center justify-center">
          ...
          >
            <div className="h-11 w-11 rounded-[14px] bg-[#F5F5F5] dark:bg-white/10 flex items-center justify-center text-[#0e0f0c] dark:text-[#7ED957] mb-5 shrink-0 border border-[#0e0f0c]/5 dark:border-white/5">
